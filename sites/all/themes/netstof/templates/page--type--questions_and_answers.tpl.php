...
<div id="header-btm-container">
    ...
    <iframe src="https://netstof.curachat.com/opeka-widgets/inline/with-sign?base_url=https://netstof.curachat.com&port=3003" frameborder="0" scrolling="no" class="chat-header-widget" style="visibility:hidden;" onload="this.style.visibility='visible';"></iframe>
	</div>
</div>
        ...
        <<?php print $tag; ?> id="main-content">
          ...
          <?php if (/*$title || */$primary_local_tasks || $secondary_local_tasks || $action_links = render($action_links)): ?>
            <header<?php print $content_header_attributes; ?>>
							<!-- below: $title disabled since itøs printed directly in the node-template -->
              <?php //if ($title): ?>
                <!--<h1 id="page-title">
                  <?php //print $title; ?>
                </h1>-->
              <?php //endif; ?>
							<!-- above: $title disabled since itøs printed directly in the node-template -->
